...
data$binned_occur <- cut(data$n_occur, breaks=c(0, 1, 2, 3, 40, 53206), labels=c("1", "2", "3", "4-40","40-53206") )
...
data_per_variant$binned_occurence <- cut(data_per_variant$total, breaks=c(0, 1, 2, 3, 40, 53206), labels=c("1", "2", "3", "4-40","40-53206")  )
...
Another way of assessing the robustness of the calls is to check if they are found in 1 or many samples. The goal here is to distinguish between low and high occuring variants so I grouped the number of occurence in bin of variable size (1, 2, 3, 4-40, 41-53202). I also created groups of allele frequencies using the maximum occuring allele frequency shown above (low AF:0-0.2, mid AF: 0.2-0.8, high AF: 0.8-1.0). 
